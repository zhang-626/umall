import { reqSpecsList, reqSpecsNum } from '../../util/request.js'
...
const actions = {
    reqchanglist(context,bool) {
        let parmos = bool ? {} :{ page: context.state.page, size: context.state.size }
        reqSpecsList(parmos).then(res => {
